...
const CostChart = () => {
  const [costData, setCostData] = useState<CostData[]>([]);  // Updated to hold an array of cost data
  const [service, setService] = useState<string>('All'); // State for storing the selected service
